...
**Scanned resources:** 28
**Total threats:** 34
**Timestamp:** 2026-03-02T18:45:21.440916+00:00
...
**Severity:** Low | **Resource:** `aws_lambda_function.model_deployer` | **Source:** rule
**MITRE ATT&CK:** T1499
...
**Severity:** Critical | **Resource:** `aws_iam_policy.sagemaker_execution` | **Source:** rule
...
**Severity:** Medium | **Resource:** `aws_lambda_function.model_deployer` | **Source:** rule
**MITRE ATT&CK:** T1190
...
**Severity:** Critical | **Resource:** `aws_s3_bucket_acl.notebook_outputs` | **Source:** rule
...
**Severity:** High | **Resource:** `aws_s3_bucket.training_data` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** High | **Resource:** `aws_s3_bucket_server_side_encryption_configuration.training_data` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** High | **Resource:** `aws_s3_bucket_versioning.training_data` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** High | **Resource:** `aws_s3_bucket_public_access_block.training_data` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** High | **Resource:** `aws_s3_bucket.model_artifacts` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** High | **Resource:** `aws_s3_bucket.notebook_outputs` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** High | **Resource:** `aws_s3_bucket_acl.notebook_outputs` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** High | **Resource:** `aws_instance.gpu_experiment_box` | **Source:** rule
**MITRE ATT&CK:** T1190
...
**Severity:** High | **Resource:** `aws_s3_bucket_logging.training_data` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** Medium | **Resource:** `aws_instance.gpu_experiment_box` | **Source:** rule
**MITRE ATT&CK:** T1530
...
**Severity:** Medium | **Resource:** `aws_vpc.ml_platform` | **Source:** rule
...
**Severity:** Medium | **Resource:** `aws_s3_bucket.training_data` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Medium | **Resource:** `aws_s3_bucket_server_side_encryption_configuration.training_data` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Medium | **Resource:** `aws_s3_bucket_versioning.training_data` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Medium | **Resource:** `aws_s3_bucket_public_access_block.training_data` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Medium | **Resource:** `aws_s3_bucket.model_artifacts` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Medium | **Resource:** `aws_s3_bucket.notebook_outputs` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Medium | **Resource:** `aws_s3_bucket_acl.notebook_outputs` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Medium | **Resource:** `aws_s3_bucket_logging.training_data` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Low | **Resource:** `aws_instance.gpu_experiment_box` | **Source:** rule
**MITRE ATT&CK:** T1562.008
...
**Severity:** Medium | **Resource:** `aws_instance.gpu_experiment_box` | **Source:** boundary
**MITRE ATT&CK:** T1040, T1557

Data flows from aws_instance.gpu_experiment_box \(dmz zone\) to aws_subnet.ml_private_a \(private zone\), crossing a trust boundary. This flow should be authenticated, encrypted, and validated.
...
Data flows from aws_instance.gpu_experiment_box \(dmz zone\) to aws_security_group.notebook_debug \(private zone\), crossing a trust boundary. This flow should be authenticated, encrypted, and validated.
